...
public abstract class Piece {
     ...
     */
     ...
     /**Método para resetar a lista de peças conectadas, removendo também na lista da peça vizinha*/
    ...
    public void fillPiecesConnected(Piece[][] boardArray){
        ...
        if(currentOutputs.contains('u')){
            ...
            }catch(ArrayIndexOutOfBoundsException e) { /* System.out.println(" HERE 02 " + (boardLine+1) + boardColumn + "\n Execeção: " + e);*/ }
        }
    ...
    /**Método auxiliar que irá obter uma peça vizinha e verificar se está conectada a Peça Principal (this)
    * @param neighboorPiece Piece - peça vizinha
    * @param auxDirection char - direção que a peça vizinha deve ter para estar conectada a Peça Principal (this)
    * 
    */
